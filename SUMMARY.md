...
* [Kiro란 무엇인가?](introduction/what-is-kiro.md)
* [왜 비개발자도 가능한가?](introduction/why-non-developers.md)

## 2부: 핵심 개념

* [Specs (스펙)](core-concepts/specs.md)
* [Steering (스티어링)](core-concepts/steering.md)
* [Hooks (훅)](core-concepts/hooks.md)

## 3부: 설치 & 설정

* [사전 준비 체크리스트](setup/checklist.md)
...
* [Step 3: 태스크 실행하기](hands-on/step3-run-tasks.md)
* [Step 4: 결과 확인하기](hands-on/step4-try-app.md)
* [Step 5: 기능 추가 요청하기](hands-on/step5-add-features.md)
...
* [실무 활용 시나리오](practical/scenarios.md)

## 6부: 마무리

* [베스트 프랙티스](wrap-up/best-practices.md)
* [리소스 & 참고자료](wrap-up/resources.md)
